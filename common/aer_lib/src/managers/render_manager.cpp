...
RendererSerializer::RendererSerializer(EntityManager& entityManager, RenderManager& rendererManager)
   : ComponentSerializer(entityManager), rendererManager_(rendererManager)
{}

void RendererSerializer::DrawImGui(Entity entity)
{
...
json RendererSerializer::GetJsonFromComponent(Entity entity) const
{
...
void RendererSerializer::SetComponentFromJson(Entity entity, const json& componentJson)
{
