...
LightSerializer::LightSerializer(EntityManager& entityManager, LightManager& lightManager)
   : ComponentSerializer(entityManager), lightManager_(lightManager)
{}

void LightSerializer::DrawImGui(Entity entity)
{
...
json LightSerializer::GetJsonFromComponent(Entity entity) const
{
...
void LightSerializer::SetComponentFromJson(Entity entity, const json& jsonComponent)
{
	PointLight light;
