...
TEST(Aabb, TestAabb)
{
    ...
    //std::cout << "AABB1 (" << aabb1.lowerLeftBound << " , " << aabb1.upperRightBound << "); AABB2 (" << aabb2.lowerLeftBound << " , " << aabb2.upperRightBound << ")  Contains :" << aabb1.DoContainAabb(aabb2) << "  Intersect :" << aabb1.DoIntersectAabb(aabb2) << "\n";
    EXPECT_TRUE(aabb1.DoIntersectAabb(aabb2));

    neko::Vec2f origin1 = neko::Vec2f(-1, -1);
    neko::Vec2f dir1 = neko::Vec2f(1, 1);
    //std::cout << "AABB1 (" << aabb1.lowerLeftBound << " , " << aabb1.upperRightBound << "); Ray (" << origin1 << " , " << dir1 << ")  Intersect :" << aabb1.DoIntersectRay(dir1, origin1) << "\n";
    EXPECT_TRUE(aabb1.DoIntersectRay(dir1, origin1));
    origin1 = neko::Vec2f(-0.5f, -1.5f);
    //std::cout << "AABB1 (" << aabb1.lowerLeftBound << " , " << aabb1.upperRightBound << "); Ray (" << origin1 << " , " << dir1 << ")  Intersect :" << aabb1.DoIntersectRay(dir1, origin1) << "\n";
    EXPECT_TRUE(aabb1.DoIntersectRay(dir1, origin1));
    ...
    //std::cout << "AABB1 (" << aabb3.lowerLeftBound << " , " << aabb3.upperRightBound << "); AABB2 (" << aabb4.lowerLeftBound << " , " << aabb4.upperRightBound << ")  Contains :" << aabb3.DoContainAabb(aabb4) << "  Intersect :" << aabb3.DoIntersectAabb(aabb4) << "\n";
    ...
    //std::cout << "AABB1 (" << aabb3.lowerLeftBound << " , " << aabb3.upperRightBound << "); Ray (" << origin2 << " , " << dir2 << ")  Intersect :" << aabb3.DoIntersectRay(dir2, origin2) << "\n";
